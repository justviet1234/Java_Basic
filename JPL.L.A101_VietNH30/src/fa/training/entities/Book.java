...
public class Book extends Publication {
	...
	public void display() {
		...
		System.out.print("isbn:" + this.isbn + ", publicationPlace:"
		+ this.publicationPlace + ", Year of publication:"
		+ super.getPublicationYear() + ", publisher:"
		+ super.getPublisher() + ", Date of publication:"
