...
public abstract class Employee {
	...
	public boolean equals(Object obj) {
		if (obj instanceof Employee) {
			...
			return (other.ssn.equals(ssn) && other.firstName.equals(firstName) && other.lastName.equals(lastName)
					&& other.address.equals(address) && other.birthDate.equals(birthDate) && other.phone.equals(phone)
					&& email.equals(email));
		}
		return false;
	}
